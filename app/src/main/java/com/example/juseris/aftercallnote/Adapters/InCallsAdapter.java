...
public class InCallsAdapter extends BaseAdapter {
    class ViewHolder {
        TextView text1;
        TextView text2;
    ...
    public InCallsAdapter(Context context, ArrayList<ContactEntity> objects) {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    case R.id.delete:
                                        ...
                                        db.deleteInCall(objects.get(itemIndex));
